...
set my_verilog_files [list  $First_Path/vdc_base2.v]
set my_toplevel vdc_base2
...
redirect Outputs_VDC/timing_vdc_13bit_base2.txt { report_timing -transition_time}
redirect Outputs_VDC/power_vdc_13bit_base2.txt { report_power }
redirect Outputs_VDC/area_vdc_13bit_base2.txt { report_area }
report_timing
